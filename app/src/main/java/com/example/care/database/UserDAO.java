...
public class UserDAO {
	...
	public int create(User user) throws SQLException {
		String sql = "INSERT INTO UserProfile (userId, password, name, address, phone) "
					+ "VALUES (?, ?, ?, ?, ?)";		
	...
	public int update(User user) throws SQLException {
		String sql = "UPDATE UserProfile "
					+ "SET password=?, name=?, address=?, phone=? "
					+ "WHERE userid=?";
	...
	public User findUser(String userId) throws SQLException {
        String sql = "SELECT password, name, address, phone "
        			+ "FROM UserProfile "
        			+ "WHERE userid=? ";              
	...
	public List<User> findUserList() throws SQLException {
        String sql = "SELECT userId, password, name, address, phone " 
        		   + "FROM UserProfile "
        		   + "ORDER BY userId";
